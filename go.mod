...
// Repeated from the shared module's own go.mod: Go ignores replace directives
// in a dependency, and without this the message filters behave differently.
replace github.com/jmespath/go-jmespath v0.4.0 => github.com/ably-forks/go-jmespath v0.0.0-20241216122026-3c2b587260de
