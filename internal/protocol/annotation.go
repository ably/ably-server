...
// MarshalJSON encodes an Annotation for a JSON transport, applying the
...
func (a *Annotation) MarshalJSON() ([]byte, error) {
	...
	return json.Marshal(&struct {
		*Alias
		...
		Alias:    (*Alias)(a),
		Encoding: jsonDataEncoding(a.Encoding, a.Data),
		Data:     a.Data,
	})
}

// UnmarshalJSON decodes a JSON Annotation, normalising its payload to the
// canonical Data representation via DataFromExternal (see data.go).
func (a *Annotation) UnmarshalJSON(b []byte) error {
	...
	data, enc, err := normaliseInboundData(v.Data, a.Encoding, false)
	if err != nil {
		return err
	}
	a.Data = data
