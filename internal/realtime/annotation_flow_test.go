...
// ANNOTATION_SUBSCRIBE receives it as an ANNOTATION frame.
...
// lacking ANNOTATION_PUBLISH is NACKed 40160.
...
// is NACKed 40400 (target validation, §14.1).
...
// unchanged serial and the folded summary (DESIGN.md §14.3).
